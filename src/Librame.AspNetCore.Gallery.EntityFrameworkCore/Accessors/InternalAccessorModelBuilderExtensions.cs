...
namespace Librame.AspNetCore.Gallery
{
    ...
    internal static class InternalAccessorModelBuilderExtensions
    {
        ...
        public static void ConfigureGalleryEntities<TSubject, TSubjectId, TSubjectArticle, TArticle, TArticleId, TArticleBody, TArticleBodyId, TCategory, TCategoryId, TEditor, TEditorId>
            (this ModelBuilder modelBuilder, GalleryBuilderOptions options)
        ...
        /// <param name="modelBuilder">给定的 <see cref="ModelBuilder"/>。</param>
        /// <param name="options">给定的 <see cref="GalleryBuilderOptions"/>。</param>
        public static void ConfigureGalleryEntities<TCategory, TCategoryId, TEditor, TEditorId, TUserId, TEditorTitle, TEditorTitleId>
            (this ModelBuilder modelBuilder, GalleryBuilderOptions options)
            where TCategory : GalleryCategory<TCategoryId>
            where TCategoryId : IEquatable<TCategoryId>
