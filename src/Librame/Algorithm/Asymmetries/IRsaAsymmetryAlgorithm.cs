...
namespace Librame.Algorithm.Asymmetries
{
    ...
    /// RSA 非对称算法接口。
    /// </summary>
    public interface IRsaAsymmetryAlgorithm : IAlgorithm
    {
        /// <summary>
        /// 对指定字符串进行签名。
        /// </summary>
        ...
        string Sign(string str, HashAlgorithmName hashName,
        ...
        byte[] Sign(byte[] bytes, HashAlgorithmName hashName,
            RSASignaturePadding padding = null, string privateKeyString = null);
        ...
        bool Verify(string str, string signedString, HashAlgorithmName hashName,
        ...
        /// <param name="publicKeyString">给定的公钥字符串（可选）。</param>
        /// <returns>返回是否通过验证的布尔值。</returns>
        bool Verify(byte[] bytes, byte[] signedBytes, HashAlgorithmName hashName,
            RSASignaturePadding padding = null, string publicKeyString = null);
