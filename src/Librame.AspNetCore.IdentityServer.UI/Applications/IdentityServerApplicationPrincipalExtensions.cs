...
namespace Librame.AspNetCore.IdentityServer.UI
{
    ...
    ///// 身份服务器应用负责人静态扩展。
    ///// </summary>
    //public static class IdentityServerApplicationPrincipalExtensions
    //{
    //    /// <summary>
    //    /// 绑定身份服务器当事人。
    //    /// </summary>
    ...
    //    public static IApplicationPrincipal BindIdentityServerPrincipal<TUser>(this IApplicationPrincipal principal)
    //        where TUser : class
    //    {
