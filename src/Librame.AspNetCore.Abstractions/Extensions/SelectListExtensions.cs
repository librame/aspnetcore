...
namespace Librame.Extensions
{
    ...
    //        where TEntity : class, IEntityId<int>
    //    {
    ...
    //                Text = text,
    //                Value = value,
    //                Selected = (selectedValue.IsEmpty() ? false : value == selectedValue)
    //            };
    //        })
    //        .ToList();
    ...
    //        string optionLabel = null, string defaultValue = null)
    //        where TEntity : class, IEntityParentId<int>
    //    {
    ...
    //        string selectedValue = null, Func<TEntity, bool> groupFactory = null,
    //        string optionLabel = null, string defaultValue = null)
    //        where TEntity : class, IEntityParentId<TId>
    //        where TId : IEquatable<TId>
    //    {
    //        if (groupFactory.IsDefault())
    //            groupFactory = g => g.ParentId.IsDefault();
