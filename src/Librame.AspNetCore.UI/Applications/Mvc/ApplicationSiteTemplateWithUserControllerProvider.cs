...
namespace Librame.AspNetCore.UI
{
    ...
    /// <summary>
    /// 带用户泛型参数的应用站点模板控制器特征提供程序。
    /// </summary>
    /// <remarks>
    /// 参考 <see cref="ControllerFeatureProvider"/>。
    /// </remarks>
    public class ApplicationSiteTemplateWithUserControllerProvider : IApplicationFeatureProvider<ControllerFeature>
    {
        ...
        /// <summary>
        /// 构造一个 <see cref="ApplicationSiteTemplateWithUserControllerProvider"/>。
        /// </summary>
        /// <param name="userType">给定的用户类型。</param>
        public ApplicationSiteTemplateWithUserControllerProvider(Type userType)
        {
        ...
        public void PopulateFeature(IEnumerable<ApplicationPart> parts, ControllerFeature feature)
        {
            foreach (var part in parts.OfType<IApplicationPartTypeProvider>())
            {
                ...
                {
                    if (type.TryGetCustomAttribute(out ApplicationSiteTemplateWithUserAttribute attribute))
                    {
