...
namespace Librame.AspNetCore.Identity.Stores
{
    ...
    [Description("默认身份用户")]
    public class DefaultIdentityUser<TGenId, TCreatedBy>
        : IdentityUser<TGenId>, ICreationIdentifier<TGenId, TCreatedBy>, IGenerativeIdentifier<TGenId>
        ...
        where TCreatedBy : IEquatable<TCreatedBy>
    {
        ...
        public override bool Equals(object obj)
            => (obj is DefaultIdentityUser<TGenId, TCreatedBy> other) && Equals(other);
