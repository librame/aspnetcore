...
namespace Librame.Builders
{
    ...
    public static class AbstractIdentityBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="builder">给定的 <see cref="IIdentityBuilder"/>。</param>
        /// <param name="configureAction">给定的 <see cref="Action{IDataBuilder}"/>。</param>
        /// <returns>返回 <see cref="IIdentityBuilder"/>。</returns>
        public static IIdentityBuilder ConfigureData(this IIdentityBuilder builder, Action<IDataBuilder> configureAction)
        {
            configureAction?.Invoke(builder.Data);
