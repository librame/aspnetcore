...
namespace Librame.AspNetCore.Identity.Stores
{
    ...
    /// </summary>
    public class GuidIdentityStoreIdentityGenerator : AbstractIdentityStoreIdentityGenerator<Guid>
    {
        /// <summary>
        /// 构造一个 <see cref="GuidIdentityStoreIdentityGenerator"/>。
        /// </summary>
        /// <param name="clock">给定的 <see cref="IClockService"/>。</param>
        /// <param name="factory">给定的 <see cref="IIdentityGeneratorFactory"/>。</param>
        /// <param name="loggerFactory">给定的 <see cref="ILoggerFactory"/>。</param>
        public GuidIdentityStoreIdentityGenerator(IClockService clock,
