...
namespace Librame.AspNetCore.Library
{
    ...
    public abstract class AbstractLibraryStore<TAccessor, TSubject, TSubjectArticle, TArticle, TArticleBody> : AbstractBaseStore<TAccessor>,
        ...
        where TArticleBody : class
    {
        ...
        public AbstractLibraryStore(IAccessor accessor)
            : base(accessor)
        {
        }
