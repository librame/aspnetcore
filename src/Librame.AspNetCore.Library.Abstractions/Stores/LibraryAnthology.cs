...
namespace Librame.AspNetCore.Library
{
    ...
    /// 文库文集。
    /// </summary>
    public class LibraryAnthology : LibraryAnthology<string, string, int, string, DateTimeOffset>
    {
        /// <summary>
        /// 构造一个 <see cref="LibraryAnthology"/> 实例。
        /// </summary>
        public LibraryAnthology()
            : base()
        {
            // 默认使用空标识符，新增推荐使用服务注入
    ...
    public class LibraryAnthology<TId, TArticleId, TCategoryId, TEditorId, TDateTime> : AbstractEntity<TId>, IPublishing<TDateTime>
        ...
        where TDateTime : struct
    {
        ...
        /// 封面标识。
        /// </summary>
        public virtual TArticleId CoverId { get; set; }
