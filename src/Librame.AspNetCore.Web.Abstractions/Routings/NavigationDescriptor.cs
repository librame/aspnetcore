...
namespace Librame.AspNetCore.Web.Routings
{
        ...
        where TResource : class, IResource
    {
        ...
        /// <returns>返回 <see cref="NavigationDescriptor{TResource}"/>。</returns>
        public virtual NavigationDescriptor<TResource> NewRouteAction(Expression<Func<TResource, string>> newActionExpression,
        ...
        /// <returns>返回 <see cref="NavigationDescriptor{TResource}"/>。</returns>
        public virtual NavigationDescriptor<TResource> NewRouteController(Expression<Func<TResource, string>> newActionExpression,
        ...
        /// <param name="newLocalizerNameExpression">给定的新定位器名称表达式。</param>
        /// <returns>返回 <see cref="NavigationDescriptor{TResource}"/>。</returns>
        public virtual NavigationDescriptor<TResource> NewRoutePage(string newPage,
            Expression<Func<TResource, string>> newLocalizerNameExpression)
