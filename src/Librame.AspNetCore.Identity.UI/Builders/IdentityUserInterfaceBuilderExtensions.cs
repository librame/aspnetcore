...
namespace Librame.AspNetCore.Identity.UI
{
    ...
    /// 身份用户界面构建器静态扩展。
    /// </summary>
    public static class IdentityUserInterfaceBuilderExtensions
    {
        /// <summary>
        /// 添加身份用户界面扩展。
        /// </summary>
        ...
        public static IUserInterfaceBuilder AddIdentityUserInterface(this IIdentityBuilderWrapper builder,
            Action<UserInterfaceBuilderOptions> setupAction = null)
        {
            var applicationPostConfigureOptionsType = typeof(IdentityApplicationPostConfigureOptions<>)
                .MakeGenericType(builder.RawBuilder.UserType);
