...
namespace Microsoft.Extensions.Logging
{
    ...
    {
        private static Action<ILogger, Exception> _redirectToIdentityProviderForSignOutHandledResponse = null;
        private static Action<ILogger, Exception> _redirectToIdentityProviderHandledResponse = null;
        private static Action<ILogger, Exception> _signOutCallbackRedirectHandledResponse = null;
        private static Action<ILogger, Exception> _signOutCallbackRedirectSkipped = null;
        private static Action<ILogger, Exception> _updatingConfiguration = null;
        private static Action<ILogger, Exception> _receivedIdToken = null;
        private static Action<ILogger, Exception> _redeemingCodeForTokens = null;
        private static Action<ILogger, string, Exception> _enteringOpenIdAuthenticationHandlerHandleRemoteAuthenticateAsync = null;
        private static Action<ILogger, string, Exception> _enteringOpenIdAuthenticationHandlerHandleUnauthorizedAsync = null;
        private static Action<ILogger, string, Exception> _enteringOpenIdAuthenticationHandlerHandleSignOutAsync = null;
        private static Action<ILogger, string, Exception> _messageReceived = null;
        private static Action<ILogger, Exception> _messageReceivedContextHandledResponse = null;
        private static Action<ILogger, Exception> _messageReceivedContextSkipped = null;
        private static Action<ILogger, Exception> _authorizationCodeReceived = null;
        private static Action<ILogger, Exception> _configurationManagerRequestRefreshCalled = null;
        private static Action<ILogger, Exception> _tokenResponseReceived = null;
        private static Action<ILogger, Exception> _tokenValidatedHandledResponse = null;
        private static Action<ILogger, Exception> _tokenValidatedSkipped = null;
        private static Action<ILogger, Exception> _authenticationFailedContextHandledResponse = null;
        private static Action<ILogger, Exception> _authenticationFailedContextSkipped = null;
        private static Action<ILogger, Exception> _authorizationCodeReceivedContextHandledResponse = null;
        private static Action<ILogger, Exception> _authorizationCodeReceivedContextSkipped = null;
        private static Action<ILogger, Exception> _tokenResponseReceivedHandledResponse = null;
        private static Action<ILogger, Exception> _tokenResponseReceivedSkipped = null;
        private static Action<ILogger, string, Exception> _userInformationReceived = null;
        private static Action<ILogger, Exception> _userInformationReceivedHandledResponse = null;
        private static Action<ILogger, Exception> _userInformationReceivedSkipped = null;
        private static Action<ILogger, string, Exception> _invalidLogoutQueryStringRedirectUrl = null;
        private static Action<ILogger, Exception> _nullOrEmptyAuthorizationResponseState = null;
        private static Action<ILogger, Exception> _unableToReadAuthorizationResponseState = null;
        private static Action<ILogger, string, string, string, Exception> _responseError = null;
        private static Action<ILogger, string, string, string, int, Exception> _responseErrorWithStatusCode = null;
        private static Action<ILogger, Exception> _exceptionProcessingMessage = null;
        private static Action<ILogger, Exception> _accessTokenNotAvailable = null;
        private static Action<ILogger, Exception> _retrievingClaims = null;
        private static Action<ILogger, Exception> _userInfoEndpointNotSet = null;
        private static Action<ILogger, Exception> _unableToProtectNonceCookie = null;
        private static Action<ILogger, string, Exception> _invalidAuthenticationRequestUrl = null;
        private static Action<ILogger, string, Exception> _unableToReadIdToken = null;
        private static Action<ILogger, string, Exception> _invalidSecurityTokenType = null;
        private static Action<ILogger, string, Exception> _unableToValidateIdToken = null;
        private static Action<ILogger, string, Exception> _postAuthenticationLocalRedirect = null;
        private static Action<ILogger, string, Exception> _postSignOutRedirect = null;
        private static Action<ILogger, Exception> _remoteSignOutHandledResponse = null;
        private static Action<ILogger, Exception> _remoteSignOutSkipped = null;
        private static Action<ILogger, Exception> _remoteSignOut = null;
        private static Action<ILogger, Exception> _remoteSignOutSessionIdMissing = null;
        private static Action<ILogger, Exception> _remoteSignOutSessionIdInvalid = null;
        private static Action<ILogger, string, Exception> _authenticationSchemeSignedOut = null;
        private static Action<ILogger, string, string, Exception> _handleChallenge = null;
        private static Action<ILogger, Exception> _remoteSignOutIssuerMissing = null;
        private static Action<ILogger, Exception> _remoteSignOutIssuerInvalid = null;


        [SuppressMessage("Performance", "CA1810:以内联方式初始化引用类型的静态字段")]
