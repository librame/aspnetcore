...
namespace Librame.AspNetCore.UI
{
    ...
    public sealed class InterfaceTemplateWithUserAttribute : InterfaceTemplateAttribute
    {
        /// <summary>
        /// 构造一个 <see cref="InterfaceTemplateWithUserAttribute"/>。
        /// </summary>
        /// <param name="implementationType">给定的实现类型。</param>
        public InterfaceTemplateWithUserAttribute(Type implementationType)
