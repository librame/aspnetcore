...
namespace Librame.AspNetCore.UI
{
    ...
    public sealed class UiTemplateWithUserAttribute : UiTemplateAttribute
    {
        /// <summary>
        /// 构造一个 <see cref="UiTemplateWithUserAttribute"/>。
        /// </summary>
        /// <param name="implementationType">给定的实现类型。</param>
        public UiTemplateWithUserAttribute(Type implementationType)
